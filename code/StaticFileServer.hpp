...
namespace argb
{
    ...
    /** This class implements a simple static file server that serves files from a specified base directory. It derives
      ...
      * so, creates a RequestHandler to handle the request and serve the file content. This safely handles path
    ...
    public:
        ...
        public:
            ...
            /** Constructs a RequestHandler for the specified file path. It checks if the file exists and is a
              ...
              */
            RequestHandler(std::string_view file_path_string);
    ...
    public:
        ...
        /** Creates a request handler for the given HTTP method and request path. If the method is GET and the request
          * path corresponds to a file within the base directory, a RequestHandler is created to serve the file
